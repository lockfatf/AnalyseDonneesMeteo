...
fviz_contrib(res_pca_vire,axes=c(1:7),choice="ind")
# Diagramme des contributions des variables
fviz_contrib(res_pca_vire,axes=c(1:7),choice="var")
contrib_ind <-fviz_contrib(res_pca_vire,axes=c(1:7),choice="ind")
```

Nous récupérons 90% de la variance à partir de 7 composantes. Sur ces 7 composante nous décidons d'ignorer l'individu contribuant à plus de 10% pour la totalite des ces axes (Dumont d'Urville).

```{r Explo2}
# Marquage des individus contribuant fortement
ind_high_contrib <- rownames(contrib_ind$data[contrib_ind$data$contrib>10,])
